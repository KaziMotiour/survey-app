...
const CreateSurvey = () => {
  ...
  // Handle remove questions
  const handleRemoveQuestion = (index) => {
    let data = [...question];
    const remvoedItem = data[index];
    const newList = data.filter((item) => item.id !== remvoedItem.id);
    setQuestion(newList);
  };

    // Handle submit new survey
  const submit = async (e) => {
    ...
    if (
      ...
      (question[0].question_type === "text" ||
        ((question[0].question_type === "radio" ||
          question[0].question_type === "multiple") &&
          question[0].options[0].qts))
    ) {
      setEpmtyField(false);
      try {
  ...
  return (
    <div>
      ...
      <Container>
        ...
        <Form>
          {emptyField && (
            <h5 style={{ color: "red", marginBottom: 20 }}>
          ...
          >
            ...
            <Col sm='10'>
              <Form.Control
                ...
                name='timer'
                value={surveyInfo.timer}
                placeholder='Survey timer'
                onChange={(e) =>
                  setSurveyInfo({
                    ...surveyInfo,
                    [e.target.name]: e.target.value,
                  ...
                  <div style={{}}>
                    ...
                    {index1 !== 0 && (
                      <Button
                        ...
                        className='addMoreOption'
                        onClick={(e) => handleRemoveQuestion(index1)}
                      >
                  ...
                  {input.question_type === "text" ? (
                    ...
                    >
                      ...
                      <Col sm='10'>
                        <Form.Control
                          question_type='text'
                          placeholder='This field is avaiable for user only'
                          disabled
                        />
                      </Col>
                    </Form.Group>
                    ...
                    <div className='mt-4'>
                      ...
                      <Button
                        ...
                        className='addMoreOption'
                        varient='primary'
                        onClick={(e) => handleAddOption(index1)}
                      >
                        Add More option
                      </Button>
                    </div>
